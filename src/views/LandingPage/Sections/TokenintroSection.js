        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={6}>
            <InfoArea
              ...
              description="PARA tokens accrue economic value by converting part of transation fees into PARA and distributing to token holders.
          ...
          <GridItem xs={12} sm={12} md={6}>
            <InfoArea
              title="Governance"
              description="Paradigm is commited to be the most inclusive yet diversified DEX.
